...
async function runTests() {
  ...
  try {
    ...
    // // // console.log(`❌ Test 1 failed with error: ${_error.message}`);
    _failedTests++;
  }
  ...
  try {
    ...
    if (hasKey === true && hasNonExistent === false) {
      ...
      // console.log(
      //   `❌ Test 2 failed: Expected true for 'key2' and false for 'nonexistent', got ${hasKey} and ${hasNonExistent}`,
      // );
      _failedTests++;
    }
  } catch (_error: unknown) {
    // // // console.log(`❌ Test 2 failed with error: ${_error.message}`);
    _failedTests++;
  }
  ...
  try {
    ...
    // // // console.log(`❌ Test 3 failed with error: ${_error.message}`);
    _failedTests++;
  }
  ...
  try {
    ...
    if (size === 0) {
      // // // console.log('✅ Test 4 passed: Clear cache');
      passedTests++;
    } else {
    ...
    // // // console.log(`❌ Test 4 failed with error: ${_error.message}`);
    _failedTests++;
  }
  ...
  try {
    ...
    // // // console.log(`❌ Test 5 failed with error: ${_error.message}`);
    _failedTests++;
  }
  ...
  try {
    ...
    // // // console.log(`❌ Test 6 failed with error: ${_error.message}`);
    _failedTests++;
  }
  ...
  try {
    ...
    // // // console.log(`❌ Test 7 failed with error: ${_error.message}`);
    _failedTests++;
  }

  // Print summary
  // // // console.log(`\nTest summary: ${passedTests} passed, ${_failedTests} failed`);
