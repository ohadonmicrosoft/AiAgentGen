...
import { AlertCircle, BarChart2, Clock, Download, Play, RefreshCw, Save, StopCircle, Trash2 } from 'lucide-react';
...
const PerformanceDashboard: React.FC = () => {
  ...
  const formatMetricsForChart = useCallback((metricName: string) => {
                          ...
                          <div key={key} className="border rounded-lg p-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                              ...
                              <div className="bg-muted p-3 rounded-md text-center">
                                ...
                                <div className="text-xs text-muted-foreground">Average Render Time</div>
                              </div>
                              <div className="bg-muted p-3 rounded-md text-center">
                                <div className="text-2xl font-bold">
