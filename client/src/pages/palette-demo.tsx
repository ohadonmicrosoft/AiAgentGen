      ...
      >
        <div>
          ...
          <p className="fluid-body text-muted-foreground mt-2 max-w-3xl">
            ...
            consistent and accessible color palettes that can be applied to customize the user interface.
          </p>
        </div>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Understanding color theory and palette generation
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="fluid-small text-muted-foreground">
                    Our palette generator creates harmonious color combinations based on color theory principles:
                  </p>
                ...
                <div>
                  ...
                  <ul className="mt-2 space-y-1 fluid-small text-muted-foreground list-disc pl-4">
                    <li><span className="font-medium">Shades</span>: Darker variations of the base color</li>
                    <li><span className="font-medium">Tints</span>: Lighter variations of the base color</li>
                    <li><span className="font-medium">Tones</span>: Desaturated variations of the base color</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="fluid-small text-muted-foreground">
                    Colors are evaluated for accessibility, with contrast ratios indicated by badges:
                  </p>
                  <ul className="mt-2 space-y-1 fluid-small text-muted-foreground list-disc pl-4">
                    <li><span className="font-medium">AAA</span>: High contrast (7:1 ratio)</li>
                    <li><span className="font-medium">AA</span>: Good contrast (4.5:1 ratio)</li>
                    <li><span className="font-medium">AA Large</span>: Suitable for large text (3:1 ratio)</li>
                  </ul>
                  <p className="mt-2 fluid-small text-muted-foreground">
                    The palette generator automatically chooses text colors that maintain readability.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Get the most out of the color palette generator
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <ul className="space-y-3 fluid-small text-muted-foreground">
                  ...
                  <li className="flex gap-2">
                    ...
                    <span>Use the "Apply to Theme" button to see the palette in action across the entire interface</span>
                  </li>
                  <li className="flex gap-2">
                  ...
                  <li className="flex gap-2">
                    <span className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-primary text-primary-foreground font-medium text-xs">4</span>
                    <span>Use the "Theme Preview" tab to see how the colors work together in UI components</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-primary text-primary-foreground font-medium text-xs">5</span>
                    <span>Pay attention to contrast ratios (AAA, AA badges) for accessibility compliance</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
