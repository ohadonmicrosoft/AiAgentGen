      ...
      >
        <div>
          ...
          <p className="fluid-body text-muted-foreground mt-2 max-w-3xl">
            Create harmonious color schemes for your AI agents. This tool helps
            you generate consistent and accessible color palettes that can be
            applied to customize the user interface.
          </p>
        </div>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="fluid-small text-muted-foreground">
                    Our palette generator creates harmonious color combinations
                ...
                <div>
                  ...
                  <ul className="mt-2 space-y-1 fluid-small text-muted-foreground list-disc pl-4">
                    <li>
                      <span className="font-medium">Shades</span>: Darker
                      variations of the base color
                    </li>
                    <li>
                      <span className="font-medium">Tints</span>: Lighter
                      variations of the base color
                    </li>
                    <li>
                      <span className="font-medium">Tones</span>: Desaturated
                      variations of the base color
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="fluid-small text-muted-foreground">
                    Colors are evaluated for accessibility, with contrast ratios
                    indicated by badges:
                  </p>
                  <ul className="mt-2 space-y-1 fluid-small text-muted-foreground list-disc pl-4">
                    <li>
                      <span className="font-medium">AAA</span>: High contrast
                      (7:1 ratio)
                    </li>
                    <li>
                      <span className="font-medium">AA</span>: Good contrast
                      (4.5:1 ratio)
                    </li>
                    <li>
                      <span className="font-medium">AA Large</span>: Suitable
                      for large text (3:1 ratio)
                    </li>
                  </ul>
                  <p className="mt-2 fluid-small text-muted-foreground">
                    The palette generator automatically chooses text colors that
              ...
              <CardContent className="space-y-4">
                <ul className="space-y-3 fluid-small text-muted-foreground">
                  <li className="flex gap-2">
                    ...
                    <span>
                      Start with a brand color as your base to maintain
                      consistency
                    </span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span>
                      Use the "Apply to Theme" button to see the palette in
                      action across the entire interface
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-primary text-primary-foreground font-medium text-xs">
                    ...
                    <span>
                      Click on any color swatch to copy its hex code to the
                      clipboard
                    </span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span>
                      Use the "Theme Preview" tab to see how the colors work
                      together in UI components
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-primary text-primary-foreground font-medium text-xs">
                    ...
                    <span>
                      Pay attention to contrast ratios (AAA, AA badges) for
