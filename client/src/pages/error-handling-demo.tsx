                  ...
                  <div>
                    ...
                    <ErrorBoundary
                      ...
                      onError={(error, info) => {
                        ...
                        console.error("Captured in error boundary:", error); // eslint-disable-line no-console
                        console.error("Component stack:", info.componentStack); // eslint-disable-line no-console
                      }}
                      onReset={() => {
                        // Perform additional reset actions if needed
                        console.log("Error boundary was reset"); // eslint-disable-line no-console
                      }}
                    >
                      <ErrorThrower />
                    </ErrorBoundary>
                    ...
                    {(() => {
                      ...
                      const WrappedComponent = withErrorBoundary(
                        () => <DelayedErrorComponent />,
                        {
                          ...
                          onError: (error) =>
                            console.log("HOC caught:", error.message), // eslint-disable-line no-console
                        },
                      );
