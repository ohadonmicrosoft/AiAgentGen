...
export function ThemeProvider({
  ...
  const [theme, setThemeState] = useState<Theme>(() => {
    ...
    if (typeof window !== "undefined") {
      try {
        ...
        console.warn("Error reading theme from localStorage:", err); // eslint-disable-line no-console
      }
    }
    return defaultTheme;
  });
  ...
  const setTheme = (newTheme: Theme) => {
    try {
      ...
      console.warn("Error saving theme to localStorage:", err); // eslint-disable-line no-console
    }
