  ...
  ({
    ...
    const handleDragEnd = React.useCallback(
      (event: MouseEvent | TouchEvent | PointerEvent, info: PanInfo) => {
        ...
        controls.start({ x: 0, y: 0, transition: { type: useSpringAnimation ? 'spring' : 'tween', bounce: 0.2 } });
      },
      [
        controls, isSwipeEnabled, swipeThreshold, direction,
        onSwipeLeft, onSwipeRight, onSwipeUp, onSwipeDown, useSpringAnimation
      ]
    );
