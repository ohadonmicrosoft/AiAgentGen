    ...
    return (
      <div
        ...
        className={cn(
          ...
          variant === 'default' && 'text-muted-foreground hover:text-foreground flex items-center justify-center',
          variant === 'minimal' && 'absolute top-2 right-2 w-6 h-6 bg-background shadow-sm border',
